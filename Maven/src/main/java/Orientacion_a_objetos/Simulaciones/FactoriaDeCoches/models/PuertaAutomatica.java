...
public class PuertaAutomatica implements DispositivoWifi {

    private String mac;
    private EstadoWifi estado;
    private LocalDate fechaActualizacion;

    public PuertaAutomatica(String mac) {
    ...
    public void conectarInternet() {
        ...
        System.out.println("Conectado usando WPA2");
    }
    ...
    public boolean pendienteActualizacion() {
        ...
        if (fechaActualizacion.plusMonths(1).isBefore(hoy)) {
            pendiente = true;
        } else {
            pendiente = false;
        }
